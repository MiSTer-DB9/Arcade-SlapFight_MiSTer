...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-SlapFight_MiSTer.git"
CORE_NAME=(Arcade-SlapFight)
...
UPSTREAM_CORE_NAME=(Arcade-SlapFight)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-SlapFight.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-SlapFight.rbf)
